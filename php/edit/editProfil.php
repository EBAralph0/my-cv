...
<form action="" method="post">
    ...
    <div class="doubleField">
        <input type="text" name="nom" id="nom" class="Monchamp" value="<?php echo $pernonne1->getNom() ?>" placeholder="Nom">
        <input type="text" name="prenom" id="Monchamp" class="Monchamp" value="<?php echo $pernonne1->getPrenom() ?>" placeholder="Prenom">
    </div>
    <div class="doubleField">
        <input type="text" name="metier" id="Monchamp" class="Monchamp" value="<?php echo $pernonne1->getMetier() ?>" placeholder="Metier">
        <input type="date" name="dateNaissance" id="Monchamp" class="Monchamp" value="<?php echo date_format($date_naiss_format,'Y-m-d') ?>" placeholder="Né le">
    </div>
    <div class="doubleField">
        <input type="text" name="regionOrigine" id="Monchamp" class="Monchamp" value="<?php echo $pernonne1->getRegionOrigine() ?>" placeholder="Region d'origine">
        <input type="text" name="paysOrigine" id="Monchamp" class="Monchamp" value="<?php echo $pernonne1->getPaysOrigine() ?>" placeholder="Pays d'origine">
    </div>
    <div class="doubleField">
